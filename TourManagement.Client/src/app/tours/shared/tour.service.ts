...
export class TourService extends BaseService {
    ...
    partiallyUpdateTour(tourId: string, patchDoc: Operation[]): Observable<any> {
        return this.http.patch(`${this.apiUrl}/tours/${tourId}`, patchDoc, { headers: { 'Content-Type': 'application/json-patch+json' } })
    }
}
